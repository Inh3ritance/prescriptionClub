...
contract PrescriptionClub is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("PrescriptionClub", "PRC") {}
    ...
    function isContentOwened(string memory uri) public view returns (bool) {
